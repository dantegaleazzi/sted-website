...
function PrivacyPolicy() {
  return <>
    ...
    <p>The current Sted applications are designed primarily around links and information associated with those links. It does not currently provide general-purpose direct uploads of photographs, raw video files, microphone recordings, or arbitrary personal files for AI processing.</p>

    <h2>2. Information we collect</h2>
    <h3>Account and guest-session information</h3>
    <p>You can use Sted without creating a registered account or providing an email address. When you first use Sted, our authentication infrastructure may create an anonymous or guest identifier so that the Service can associate your saved links, projects, settings, generated information, and other application data with your session.</p>
    <p>Where available, Sted may also offer optional account sign-in methods, including Sign in with Apple. Sign in with Apple is not required to save links or use Sted as a guest.</p>
    <p>If you choose to use Sign in with Apple, depending on the information you choose to share through Apple, we may receive your name, email address or Apple private relay email address, and identifiers needed to authenticate and maintain your Sted account.</p>
    <p>We use identifiers generated by our authentication infrastructure to associate your saved content and other Sted data with your account or guest session.</p>
    ...
    <p><strong>Apple</strong> — optional Sign in with Apple functionality and distribution of the iOS application through the App Store.</p>
    ...
    <p>Saved links, stored extracted information, projects, notes, generated information, and related account or guest-session data are generally retained until you delete the applicable content or delete your account.</p>
    ...
    <p>You can initiate deletion of your Sted data from within the application through Settings using the applicable deletion control.</p>
    <p>For guest users, deletion removes the data associated with the applicable guest session from Sted’s active application database, subject to the limited retention described above. In the iOS application, deletion also resets the application to a new guest state.</p>
    <p>For registered or linked accounts, account deletion removes the Sted account and associated saved items, projects, stored extracted information, user-created organization data, settings, and generated information from Sted’s active application database, subject to the limited retention described above.</p>
    <p>Where applicable, Sted also attempts to revoke credentials associated with Sign in with Apple as part of deleting a linked account.</p>
