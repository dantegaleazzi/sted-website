...
function PrivacyPolicy() {
  return <>
    ...
    <p>This Privacy Policy explains how we collect, use, disclose, and otherwise process information when you use the Sted iOS or Android applications, the Sted Share Extension, sted.ai, and related services (collectively, the “Service”).</p>
    ...
    <p>Authentication features may vary by platform and version.</p>
    <p>On the current iOS version, Sted does not require or offer user-facing account registration or sign-in. Sted uses an automatically created anonymous technical identifier/session to associate saved content, projects, settings, and other Sted data with the correct installation/user context. Users are not asked to register, provide an email address, or authenticate.</p>
    <p>On platforms or versions where account creation or authentication is offered, such as Android where applicable, we may collect the information required to create and authenticate the account, such as an email address and authentication identifiers. The specific authentication options available are shown in the applicable version of Sted.</p>
    ...
    <ul>
      <li>create and maintain guest sessions and, where applicable, authenticate and maintain Sted accounts;</li>
    ...
    <ul>
      <li><strong>Contract:</strong> to establish and maintain your guest session or account, where applicable, and provide the core Sted features you request, including saving, retrieving, displaying, searching, and organizing your content.</li>
    ...
    <p><strong>AI processing is not enabled for your session or account until you give the applicable permission.</strong> You can subsequently turn AI processing off in Sted Settings.</p>
...
export function LegalPage({ document }: { document: LegalDocument }) {
  ...
  useEffect(() => {
    if (document === 'delete-account') return
