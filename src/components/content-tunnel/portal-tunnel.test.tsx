...
describe('internal portal tunnel', () => {
  it('renders sixteen slots with one authorized temporary duplicate SourceCards without synthetic media', () => {
    ...
    expect(html).toContain('source-card__media-image')
    ...
    expect(portalFixtures.filter(item => item.image)).toHaveLength(15)
  ...
  it('preserves the original fallback and default tunnel behavior', () => {
    const item = { ...portalFixtures[2], verifiedContent: false, image: undefined, imageAlt: undefined }
